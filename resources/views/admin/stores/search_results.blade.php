    ...
    <div class="col-12">
        <div class="card shadow-lg border-0">
            <div class="card-body">
                ...
                <a href="{{ route('admin.store.create') }}" class="btn btn-primary mb-3">Add new store</a>
                @if(session('success'))
                    ...
                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                        ...
                        <tbody id="tablecontents">
                            ...
                            <tr class="row1" data-id="{{ $store->id }}">
                                ...
                                <td>
                                    <a href="{{ route('admin.store.edit', $store->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                ...
                                <td>
                                    <a href="{{ route('admin.coupon.index', ['store_id' => $store->id]) }}" class="btn btn-info btn-sm">View Coupons</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
